...
> One place for the project's settled calls and its *deliberate* deferrals. **LOCKED** = fixed
> for drafting. **DEFERRED BY DESIGN** = a choice the *writing* should make, not abstract
> deliberation — leans recorded so they're not open holes. Last updated 2026-05-31.

## LOCKED — names
| Thing | Locked value | Note |
|---|---|---|
| The slayer | **Garran** (male) | was working "Dern"; file [[garran]] |
| The Hum's builder | **Brask** | confirmed; **now a POV** (penultimate chapter, rev. 2026-05-31) — [[brask]] |
| Brask's co-designer | **Korrin** *(provisional)* | dwarf fuel-engineer; co-builds the Hummingbirds; a **separate** younger dwarf, deliberately *not* [[grundrak\|Grundrak's]] line |
| The dragons' medium | **the murmur** | rock-borne, deep, *emergent* (murmuration) — vs the Hum's air-borne broadcast — [[the-hum]] |
| Dalla's interviewer | **Sennet** | "the Host" still usable as role — [[sennet]] |
| The King | *unnamed* (deliberate) | the institution — [[the-king]] |
| The Dragon | *unnamed* (deliberate) | pre-linguistic — [[the-dragon]] |
| The transit | **the Underway** | guano-powered underground railway |
| The broadcast medium | **the Hum** (verb: to *hum*) | received on a **humbox** |
| The interview slot | **the Hour** | "she's on the Hour at seventh bell" |
| The catalyst bee | **footbee** (a foot long, lethal) | makes the honey catalyst |
...
- **Non-POV characters:** [[sennet]] (in Dalla's transcript) and [[korrin]] (in Brask's chapter).
  *([[brask]] is no longer non-POV — he narrates the penultimate chapter; Vesser II is now the*
  *outside view that sets up Brask's inside view, not the sole window onto him.)*
- **[[marga|Marga]] added** — the proletarian account & the [[the-guild|Guano Guild's]] human face.
- **Sapper: folded (not added)** — cast-size; [[grundrak]] carries applied-guano violence. [[guilds]]
- **Peacekeeper: folded** into [[garran|Garran's]] chapter; **beekeeper:** texture in [[labour-and-order]].
- **The Guild account: a single document, now antepenultimate** (running tail = **Guild → [[brask|Brask]] → [[the-dragon|Dragon]]**; was penultimate before Brask's chapter was added). Not interleaved interludes. [[the-guild]]
...
- **[[brask|Brask]] promoted to a POV** (penultimate chapter): a flat, un-introspective
  *technological-progress account* — the obliviousness **is** the characterisation. Reverses
  the earlier non-POV lock. He is the (publicly **uncredited**) inventor of the Hum **and**
  co-designer of the **Hummingbirds**; the Guild credits "the guilds," the public credits
  [[vesser|Vesser]] and [[dalla|Dalla]]. His swarm-coordination of the Hummingbirds is,
  unknowingly, the same murmuration principle the dragons use to escape.
- **[[vesser|Vesser]]'s populariser second act** (Carmack/Romero; Brask = Carmack): displaced
  from the lift, he reinvented as the Hum's charismatic public face — a Rashomon gap with his
  own self-pitying elegy, licensed by Vesser-I's confessed unreliability. He lost the craft and
  was rewarded for the charm (rhymes with [[dalla|Dalla]] and [[garran|Garran]]).
- **Voice registers split deliberately:** high/lyrical ([[the-king|King]], [[vesser|Vesser]],
  [[the-dragon|Dragon]]) vs low/plain ([[grundrak|Grundrak]], [[brask|Brask]], [[marga|Marga]]).
  Grundrak and Brask re-voiced *"worse"* on purpose — earthy-oral and flat-clipped respectively
  — to break the uniform-eloquence problem the review flagged (one earned polished spike kept
  each). [[grundrak|Grundrak's]] account also **anchored early** (pre-coup, pre-Hum) and
  de-anachronised (no Dalla-unit/hat, no dragon-tasters, no "hum" verb).
- **The dragons' medium named: the murmur** — rock-borne, deep, *emergent/leaderless*
  (murmuration), vs the Hum's air-borne **centralised broadcast**; the two media mirror the two
  political orders, and the leaderless murmur keeps the defection **uncommandable** (cold ending
  intact — "you cannot break the wings of a pattern"). [[the-hum]] · [[dragons]]
- **Dragon-chapter additions:** the **wing-breaking suppression** of a dissident young dragon by
  other (contented) dragons, laundered as mercy and generalised to **sanitoriums** (caves where
  "sick" dragons are tube-fed pork slurry, doublethink); the Dragon's broadcast is a **self-aware
  apex-predator counter-myth**, not neutral truth; **soft-cage cave geography** ("no door" — the
  cave-mouth stands open, the Hummingbird threatens to close it without bars). Drone-discovery
  fixed to an **in-chamber demonstration** (voice-only world — no video). [[dragons]] · [[the-dragon]]
- **Hummingbird breadcrumbs** seeded across the post-Hum chapters ([[the-king|King]],
  [[the-guild|Guild]], [[vesser|Vesser]] II, [[garran|Garran]]) so the Dragon's concern isn't
  leftfield; the Guild's boast tees up Brask.
- **[[the-princess|Princess]]** thickened (sensory cold-keep vs warm-below + the unfelt ancestral
  rite — reverence lost); **[[dalla|Dalla]]-private** gains the compensation / indignity /
  local-optimum beat, rhymed to the Dragon's soft cage.
...
- **Catalyst = honey** (from footbees); **ignition rules:** dragonbreath never ignites; only *dried* guano ignites. [[guano]]
- **Two novums:** [[guano|guano]] (hard) + [[the-hum|the Hum]] (soft); the Hum **discovered twice** (mages, then dragons).
- **Dragon ending — lean C** (the dragon-Hum, played cold; B/A as dials). [[dragons]]
...
- **"How much does X articulate vs. the reader infer"** (prose decides each):
  ...
  - [[the-king|King]]: does he grasp the unit/source rhyme (lean: reader-assembled).
  - [[dalla|Dalla]]: how early the "I fell" turn lands (lean: lampshade early, the "named a unit after it" later).
  - [[garran|Garran]]: witnesses a Hummingbird demonstration on-page (lean: **yes, climax**); understands the Dragon link (lean: **no**, one unbidden memory near the end).
  - [[marga|Marga]]: corrects vs. ignores the grand narratives (lean: **ignores** — the gap does the work); fatalism over unawareness.
  - [[sennet|Sennet]]: how much he knows he's performing (lean: **half-knows, won't look**); recurs beyond Dalla's chapter (lean: **no**).
- **Hum legibility:** how much of its mechanism the reader understands (keep it the softer novum).
- **[[the-dragon|Dragon]] POV:** first-person throughout vs. only the retrospective outer frame (drafting call).
- **[[marga|Marga's]] crew micro old/new** (Aldric the ex-adventurer) — optional; use only if it doesn't crowd her ground-truth.
- **Do [[dalla|Dalla]] and the [[the-guild|Guild]]/[[sennet|Sennet]] ever share *the Hour* on air?** (dangerous, delicious — decide in draft.)

## Still genuinely open (iteration drivers, not blockers)
- Geography beyond the three named sites; what dragons eat in husbandry (who profits one tier up);
  whether the "Dalla" unit is defined on-page in the Guild account or only felt in Dalla's.
