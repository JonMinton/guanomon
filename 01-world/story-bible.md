...
The single source of truth for world-facts. If a chapter needs a new fact, add it
here *first*, then write the chapter against it. This is the discipline that keeps
the accounts from silently contradicting one another.
...
A Tolkienesque world discovers that **dragon dung is an extraordinarily potent
fuel**. The rational response to dragons therefore inverts: not slaying but
husbandry. You feed and farm dragons and collect the output. Hoarded treasure
becomes an irrelevance — the metabolic product is worth more than the gold the
dragon sleeps on. Dragon-slayers become *villains*: they are destroying critical
energy infrastructure. (This is the Batman-philanthropy argument applied to
...
> dung. **No one had ever been soiled this way before.** It is so obvious in
> retrospect that it seems unbelievable — but that is what happened. The discovery
> required an *accident* ([[dalla|Dalla's fall]]), and the accident required someone
> to break the one rule everyone had always kept. The lampshade *is* the device; it
> rhymes with the [[the-guild|Guild's]] founder-myth laundering and with Scene 1's
> crew treating the treasure with indifference. See [[discovery-gating]] for why this
> beats the "serious" economic fixes here.
...
- Collection requires specialisation and proximity to extremely dangerous animals,
  ...
  - **Sappers' Guild — now the balance of power (2026-05-31):** feedpipes, power, engineering,
    ...
    ([[the-guild]], chapter 13) is delivered by the **Sappers' chair**. The new chair's voice is
  ...
  - **Food-input guilds — Farmers' & Butchers' (minor but essential):** the husbandry regime feeds
    ...
    luxury). All three are folded as texture, named in the Guild address ([[the-guild]], ch.13) and
    in [[the-dragon]] (ch.15). Source: [[earlier-dragon-and-food-economy]].
...
- Mages *can* produce comparable effects to guano, but at **enormous personal cost
  and far lower throughput**. The distinction is **artisanal vs industrial**, not
...
- **Diagnosis by urine-tasting**: etymologically grounded (cf. *mellitus*, "honey-
  sweet"). The world's physicians taste to diagnose; the dragon's sweetened urine is
  the tell of her metabolic decline.
- **Dragon-urine confectionery**: a grotesque luxury for elites — a class detail
  that shows the by-products being financialised all the way down.
- **Reduced collection scheduling**: as supply systematises, crews visit less often.
...
Thirty years of an engineered feeding regime makes the dragon **metabolically ill**.
Her dissatisfaction is embodied, not emotional: sickness redirects appetite, and the
appetite turns back toward humans ("long pig"). The comfort that contained her is
...
- **The lair / deep chamber** — the dragon's containment, increasingly plumbed and
  scheduled.
- **Arrath Keep** — site of the original military demonstration (now off-page).
- **The palace / throne room** — site of the coup and, a decade on, of colonial
  planning.
...
- How visible is the fossil-fuel allegory allowed to get before it becomes
  heavy-handed (the Boxer problem again)?
- Geography beyond the three named sites — how large is the polity that gets
  "demonstrated to"?
