# Above and below — the world's vertical axis

> A world-entity note. The story has a **spatial backbone**: an *above-ground* world
> (human, royal, old order) and a *below-ground* world (dwarven, industrial, new order).
> The [[guano|First Novum]] **inverted the power between them**, draining it downward.
> This is the geography the themes hang on.

## The two worlds
| | **Above** | **Below** |
|---|---|---|
| Peoples | humans | dwarves |
| Associations | sun, surface, court, field, sky | rock, tunnel, forge, mine, the deep |
| Old metier | sovereignty, agriculture, cavalry/open warfare, (airy) magecraft | extraction, processing, combustion, engineering |
| Status now | ceremonial, displaced, *looked down on from below* | ascendant, real power |

## The inversion — caused by the First Novum
Before guano, power lived **above**: the King on his surface throne, humans on top, the
underground a place of labour and monsters. [[guano|Guano]] reverses this. The
world-remaking value now comes from **below** — the dragon's deep chamber, dwarven
extraction and processing — so power drains *downward*, from the old surface order to the
...
- **To reach power now you descend and stoop.** The [[story-bible|guano-powered subway]]
  runs *below*; its tunnels are built [[story-bible|deliberately too low]] so humans must
  **bow** to use dwarven tech. Access to the new order is literally a downward,
  submissive motion.
- **The descent motif.** Scene 1 is *"The Descent"* — the crew goes *down* into the
  dragon's chamber to collect the source. [[dalla|Dalla]] *fell* — downward — into the
  dung. The story's foundational acts are all descents.
- **The court above is hollowed.** The [[the-king|King's]] surface palace becomes
...
- Characters who embody the axis: [[the-king]]/[[the-princess]] (above, falling) · [[grundrak]] (below, rising) · [[the-dragon]] (the deepest source of all)
