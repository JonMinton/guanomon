# The Hum — the Second Novum

> A world-entity note. **The Hum is the Second Novum** — mass communication, the mages'
> real legacy. Conceptual home here; full mechanics live in [[story-bible]] ("The second
> novum"). It exists *because of* [[guano]] (see below).

## What it is
A means of **mass communication — voice only**, carried live to many receivers at once
(something very like radio). To broadcast a thing is to **hum** it — lowercase verb,
...
is cheap; power is expensive.** Magic was always good at *resonance, sympathy, connection
at a distance* — so the thing the mages could **not** industrialise (energy) sat right
...
- **Manufactures celebrity.** [[dalla|Dalla]] is paraded on it as "the discoverer" —
  ...
  private monologue) turn on this.
- **Carries the official story.** [[the-guild|The Guild's]] founder-myth is *hummed*,
  continuously, in relentless positivity — the displaced mages' invention become the
  megaphone for the order that displaced them.
- **Voice only → mythologisation.** No images, so a broadcast persona drifts free of the
...
novum and one soft one** — the [[genre-theory|hard/soft magic axis]] dramatised as
political economy. Hard power moves *matter* (guano); soft power moves *meaning* (the
Hum).
