...
2. **A sapper (strong optional — still open).** Explosives handling links the coup,
   ...
   trade whose whole meaning is killing).
3. **Peacekeeper — fold into [[dern]]** (already a subplot) unless it earns its own face.
...
## See also
- [[the-guild]] (the institution / its voice) · [[labour-and-order]] (the reorganised economy) · [[plot-beats]] (cast & order) · reps: [[vesser]] · [[brask]] · [[dern]] · [[grundrak]] · [[dalla]]
