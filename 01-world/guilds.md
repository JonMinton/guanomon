...
| **Hummers'** *(Alchemists' spin-off)* | — (new) | tend the [[the-hum|Hum]] apparatus / broadcast | named in the Guild address (ch.13); performers via [[sennet|Sennet]] | folded — institutional |
...
| **Farmers'** *(food input)* | village agriculture | raise the livestock that **feeds the dragons** (pork/beef/mutton at scale) | named in the Guild address (ch.13); [[earlier-dragon-and-food-economy]] | folded — minor, input-side |
| **Butchers'** *(food input)* | village trade | slaughter & deliver the source's feed | named in the Guild address (ch.13); [[earlier-dragon-and-food-economy]] | folded — minor, input-side |
| **Confectioners'** | sweets / luxuries | buy the dragons' sweet by-products ("essence of drake") | ch.13 & [[the-dragon]] (ch.15); [[earlier-dragon-and-food-economy]] | folded — minor |
...
2. **A sapper — RESOLVED at the institutional level (2026-05-31).** No dedicated personal POV
   ...
   of power**, the **Sappers' chair delivers the confederated Guild address** (chapter 13), so the
...
address (ch.13)** — so the institution *does* have a voice, the official voice of the age.
