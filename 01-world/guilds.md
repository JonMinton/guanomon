# Guilds — the concepts, and the characters who carry them

> **Principle (load-bearing — keep returning to it):** a **guild is a concept / institution,
> never a character.** Each guild's *human* story must reach the reader through an
> **individual representative.** "The Guild" may supply an institutional *voice* (an aired
> bulletin, a charter), but the lived experience of every guild is carried by a person. This
> note maps guild → representative and flags the gaps so no guild is left as a faceless
> abstraction.
...
| **Hummers'** *(Alchemists' spin-off)* | — (new) | tend the [[the-hum|Hum]] apparatus / broadcast | named in the Guild address (ch.12); performers via [[sennet|Sennet]] | folded — institutional |
...
| **Sappers'** | dwarven mining / demolition *(predominantly dwarven; pre-novum often **human-headed** as a political appointment — see [[labour-and-order]])* | feedpipes, power, engineering, [[guano|repotentiation]], [[story-bible|Hummingbird]] ordnance; **now hold the balance of power**; human minority tier works the surface drying/compression | **institutional voice = the confederated Guild address (now ch.12), delivered by the (dwarven) Sappers' chair**; [[grundrak]] for applied-guano violence | ✓ covered (institutional) |
...
| **Farmers'** *(food input)* | village agriculture | raise the livestock that **feeds the dragons** (pork/beef/mutton at scale) | named in the Guild address (ch.12); [[earlier-dragon-and-food-economy]] | folded — minor, input-side |
| **Butchers'** *(food input)* | village trade | slaughter & deliver the source's feed | named in the Guild address (ch.12); [[earlier-dragon-and-food-economy]] | folded — minor, input-side |
| **Confectioners'** | sweets / luxuries | buy the dragons' sweet by-products ("essence of drake") | ch.12 & [[the-dragon]] (ch.14); [[earlier-dragon-and-food-economy]] | folded — minor |
...
2. **A sapper — RESOLVED at the institutional level (2026-05-31).** No dedicated personal POV
   ...
   of power**, the **Sappers' chair delivers the confederated Guild address** (chapter 12), so the
...
> **Cast-size caution:** ~10 accounts / 8 narrators already ([[plot-beats]]). The **labourer**
...
address (ch.12)** — so the institution *does* have a voice, the official voice of the age.
