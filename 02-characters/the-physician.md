...
audience, the Physician launders for himself, in real time, on the page.
**Register:** low/plain family (with [[grundrak|Grundrak]], [[brask|Brask]], [[marga|Marga]])
but a distinct flavour: hedged, formulaic, passive-clinical, quantity-precise. The feeling is
*managed*, not absent — discipline, with leaks. His signature device is the **margin/record
distinction**: what he half-knows goes into margins, then gets formally disowned ("The margin
is not the record").

## Role in the system
**Physician-in-Ordinary to the Source** — and the office is the joke the chapter never makes:
it was the *crown's* office. Taster to the royal body, keeper of its waters, an inheritance
of court medicine going back generations. The body that matters moved, and the office moved
with it, *downward* (the [[above-and-below|above→below inversion]] written into one man's
job). His grandmother tasted for a queen; he tastes for the Dragon. The art is unchanged.
The patient is larger.

He is unnamed — like the [[the-king|King]], he *is* an office; unlike the King, he never
noticed the office change masters. (His case-book is "the property of the Guild": even his
record is owned.)

## What he carries (the payload redistribution)
Beats the [[the-dragon|Dragon's]] final chapter currently delivers alone, now seeded earlier
in clinical form — so the final chapter can shed exposition and keep dread:

- **The diabetes mechanism**, lived: quarterly sampling, *mellituria*, sweetness rising,
  the reduction-of-feed recommendation renewed and overridden every year ("output
  considerations are cited").
- **The herd-wide degradation** ([[dragons]] §finitude): he compiles cross-site returns
  nobody asked for, tabulates earlier onset in younger animals, and is reassured by
  committee ("an artefact of improved measurement") — denial dressed as method, on the page,
  before the Dragon ever says "the comfort is killing me."
- **The wing-breaking / sanitoriums**, human-side reading: "restraint was achieved with the
  assistance of two senior animals… pinions were reduced at the joint, to prevent
  self-injury… the animal is calm. Calm has a definition in my ledger: it accepts the pipe."
  Same event as the Dragon's account, opposite laundering — the Rashomon method applied to
  the book's darkest beat.
- **Clutch separation** (new canon — see [[dragons]] §society): dams' distress "settling"
  within the month. *"I record it as settling. There is no other column."*
- **The requisitions**, misread: the Dragon's fussy treasure requests scored highly under
  *engagement* — "an animal that takes an interest is a well animal."
- **The in-chamber Hummingbird trial** ([[hummingbirds]] breadcrumb): stimulus trial, response
...
## What he's structurally blind to (or won't look at)
He is the human mirror of the **contented suppressor dragons** ([[dragons]] §suppression):
every incentive points him to the humane reading, and he takes it, *knowing and not knowing
in the one mind at the one time*. The doublethink the Dragon describes in her own kind,
demonstrated in a human, in his own hand. His tragedy-shape: he keeps perfect records of a
catastrophe and files them where records are filed. The one thing he never does is *pursue
...
- **[[marga|Marga]]**: both keep flat professional registers over uncounted death; hers
  refuses the system's grand frames, his *is* one.

## Voice notes
- Formulae as fingerprint: "The recommendation is renewed." "X has a definition in my
  ledger." "Filed where Xs are filed."
- No first-person feeling on the record; leaks confined to margins, then disowned.
- One metaphor in the whole chapter, maximum, and it should escape rather than be chosen.
- Quantities exact, conclusions hedged — the inverse of the Guild (conclusions confident,
  quantities vague).
...
- Does the Dragon's chapter acknowledge him at all beyond the taster line? (Lean: no — to
  her he is furniture that tastes; the asymmetry is the point.)
- If adopted, which Dragon-chapter paragraphs get thinned in consequence —
  see [[second-iteration-proposals]] §4.
