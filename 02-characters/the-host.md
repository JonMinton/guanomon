...
(John Wilson), with a Parkinson/Wogan warmth. He performs **intimacy, curiosity and depth**;
asks "searching" questions that are really softballs dressed as profundity; and
**co-produces the guest's persona** while seeming to reveal the "real" them. The genial,
...
"I fell" anecdote and gets the audience to laugh; he makes the [[the-guild|founder-myth]]
feel like warmth and candour. He and Dalla *together* manufacture the public Dalla of her
on-air chapter — which is exactly what her **private chapter then dismantles.** The Host is
therefore **load-bearing for the Dalla diptych:** no Host, no front stage to strip.

## Idiosyncrasies (so he's specific, not a cardboard archetype)
- **The signature move:** a performed pause, then *"Now — and I hope you won't mind my asking
  this —"* before a question he has put to a hundred guests. Faux-vulnerability as technique;
  a manufactured hush before a softball.
- **A bard, repotentiated.** He is an **old-world bard** (court entertainer / praise-singer)
...
- **With Dalla specifically:** she's a **recurring guest, "a national treasure"**; they have a
  ...
  or willed not-looking (the [[the-princess|Princess's]] blindness in a different key).
  *Richest: he half-knows it's all performance and declines to look.*

## The chapter form (record in [[dalla]] too)
Dalla's on-air account is **the only transcript / play-script chapter** — the broadcast as the
public consumed it: speaker labels, the Host's patter, Dalla's performed answers, *[AUDIENCE
LAUGHTER]* cues. Pure front stage, no interiority — formally the *opposite* of [[marga|Marga's]]
back-stage realism and of Dalla's own private monologue. The reader is handed the artefact,
and only later gets to see behind it.

## Voice notes
- Honeyed, fluent, never silent for long; fills pauses with affirming noise (*"mm," "quite,"
  "how *fascinating*"*).
